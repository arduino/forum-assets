See also [FAQ - Arduino Forum](https://forum.arduino.cc/faq) for general rules on forum behavior and etiquette.
...
If you want to use computer software to create a schematic, then you might like to try [Circuit Diagram](https://www.circuit-diagram.org/) or [KiCad](https://www.kicad.org/), although any software capable of creating a schematic will be fine.
